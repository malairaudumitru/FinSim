...
import { nt as useRouter, s as useRouterState } from "./index.dev-D_LpX_3B.js";
import { S as render, a as ShadowDomTargetContext, m as createSignal, t as DevtoolsOnCloseContext, u as createComponent, v as lazy } from "./context-De2EB1AA-K2uduI_Q.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-CNROBv9F-CzCgi7g2.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) BaseTanStackRouterDevtoolsPanel = this.#Component;
				...
				BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-fP2H3uLR-B9ZydOCx.js"));
