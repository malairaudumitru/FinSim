...
export const initialHistory: HistoryEntry[] = [
    { id: 'h1', scenariu: 'Primul salariu', data: '02.09.2026', scor: 82 },
    { id: 'h2', scenariu: 'Chirie și facturi', data: '28.08.2026', scor: 65 },
    { id: 'h3', scenariu: 'Urgență medicală', data: '20.08.2026', scor: 74 },
    { id: 'h4', scenariu: 'Primul salariu', data: '16.08.2026', scor: 58 },
]
