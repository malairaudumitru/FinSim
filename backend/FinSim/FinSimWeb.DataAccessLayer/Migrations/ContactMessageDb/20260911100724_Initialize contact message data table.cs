...
{
    /// <inheritdoc />
    public partial class Initializecontactmessagedatatable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Raspuns = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    RaspunsData = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
